...
public:
	...
	int		GetShInputStart(){ return m_vShInputStart; }
	int		GetShInputEnd(){ return m_vShInputEnd; }
	int		GetShOutputStart(){ return m_vShOutputStart; }
	int		GetShOutputEnd(){ return m_vShOutputEnd; }
...
protected:
	...
	/* Aseem:Share input start and share output end */
	int     	m_vShInputStart;
	int             m_vShInputEnd;
	int     	m_vShOutputStart;
	int             m_vShOutputEnd;
