...
/* Aseem:shares input and output wires */
const char T_SHINPUTDESC = 's';
const char T_SHOUTPUTDESC = 't';
...
BOOL CCircuit::Load(const char* filename)
{
	...
	{ 	
		...
		case T_COMMENT:
			break;
		default:
		 	cout << "unrecognized command in circuit line (skip)" << nLineNum << ": " << sLine << endl;
		}
